...
class CalculateTax {
	 ...
	 * @param bool          $for_refund States whether the transaction is a refund.
	 * @return float
	 */
	public static function get_order_item_total_amount( $order_item, $quantity, $for_refund ) {
		if ( $for_refund ) {
			return (float) $order_item->get_total( 'edit' );
		}

		$product = $order_item->get_product();
		return (float) ( $product->get_price( 'edit' ) ) * $quantity - self::get_order_item_discount_amount( $order_item );
	}
